...
class Group_Info extends StatefulWidget {
  static const String route_Group_Info = 'Group_Info';
    ...
    return Scaffold(
      ...
      body: Column(
        children: <Widget>[
          ...
          Center(
            child: CircleAvatar(
              backgroundImage: const AssetImage("assets/image/2.jpg"),
              radius: 70.r,
            ),
          ),
                ...
                child: InkWell(
                  ...
                  child: Padding(
                    ...
                    child: Icon(Icons.add,
                        size: 25.0.sp, color: const Color(0xffff4b26)),
                  ),
                ),
              ),
              SizedBox(width: 40.w),
                ...
                Expanded(
                  child: TextButton(
                      ...
                      child: Text(
                        'Voice',
                        style: TextStyle(
                            color: index == 4 ? enabledColor : disableColor,
                            fontSize: 15.sp),
                      )),
                ),
              ],
            ...
            children: [
              TextButton(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                        color: const Color(0xffff4b26), fontSize: 15.sp),
                  )),
            ],
          ),
          SizedBox(height: 40.h),
          Row(
            ...
            children: [
              Text(
                ...
                textAlign: TextAlign.left,
                style:
                    TextStyle(color: const Color(0xfffffdfd), fontSize: 25.sp),
              ),
              Expanded(
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.end,
          ...
          children: [
            ...
            TextButton.icon(
              ...
              label: Text(
                'Exit From Group',
                style:
                    TextStyle(color: const Color(0xffff4b26), fontSize: 20.sp),
              ),
            ),
          ],
        ),
